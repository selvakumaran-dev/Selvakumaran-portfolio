    ...
    <div className="flex flex-col md:flex-row items-center gap-10 premium-glass animate-glow p-6 md:p-12 rounded-3xl shadow-lg hover:shadow-[0_0_25px_rgba(251,191,36,0.6)] transition duration-300">
      ...
      <div className="md:w-1/2 text-center md:text-left">
        ...
        <p className="text-gray-300 mb-6">
          My Secure Era is a production-ready, peer-to-peer encrypted file sharing application that enables secure file transfers directly between browsers using WebRTC. Files are never uploaded to or stored on any server.
        </p>
        <div className="flex gap-4 justify-center md:justify-start">
          <a
            href="https://secure-era-client.onrender.com"
            target="_blank"
            rel="noreferrer"
